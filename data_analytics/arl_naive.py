...
class ARLNaiveBayes(PassengerNaiveBayesModel):
    """Naive Bayes model for Airport Rail Link"""
    ...
    def preprocess(self, df=pd.read_csv("integrated_weather_and_train.csv"), organization="ARL"):
